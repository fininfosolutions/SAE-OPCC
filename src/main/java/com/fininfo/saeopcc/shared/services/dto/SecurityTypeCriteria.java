...
/**
 * Criteria class for the {@link com.backupswift.referentiel.domain.SecurityType} entity. This class
 * is used in {@link com.fininfo.saeopcc.shared.controllers.SecurityTypeResource} to receive all the
 * possible filtering options from the Http GET request parameters. For example the following could
 * be a valid request: {@code
 * /security-types?id.greaterThan=5&attr1.contains=something&attr2.specified=false} As Spring is
