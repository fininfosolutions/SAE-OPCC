...
//   private static final String ERROR_MESSAGE_TEMPLATE = "unable to send message='%s'";
//   private static final String JSON_ERROR_MESSAGE = "Error parsing JSON data: {}";
//   private static final String SCHEMA_KEY = "Schema";
//   private static final String MESSAGE_WITH_OFFSET_FORMAT = "sent message='{}' with offset={}";
...
//   @Value("${kafkaTopics.contracttopicFromopccToConsumers}")
