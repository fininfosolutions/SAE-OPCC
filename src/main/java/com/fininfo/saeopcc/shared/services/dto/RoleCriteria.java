 ...
 * in {@link com.fininfo.saeopcc.shared.controllers.RoleResource} to receive all the possible
 * filtering options from the Http GET request parameters. For example the following could be a
 * valid request: {@code /roles?id.greaterThan=5&attr1.contains=something&attr2.specified=false} As
