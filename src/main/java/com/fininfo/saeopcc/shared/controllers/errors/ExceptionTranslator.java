package com.fininfo.saeopcc.shared.controllers.errors;

import com.fininfo.saeopcc.configuration.HeaderUtil;
import com.fininfo.saeopcc.configuration.ReferentielConstants;
import com.fininfo.saeopcc.util.exceptions.ErrorResponse;
import com.fininfo.saeopcc.util.exceptions.ValuationException;
import java.net.URI;
...
public class ExceptionTranslator implements ProblemHandling, SecurityAdviceTrait {
  ...
  @ExceptionHandler
  public ResponseEntity<?> handleValuationException(
      ValuationException ex, NativeWebRequest request) {
    ErrorResponse response = new ErrorResponse("VALO", ex.getMessage());
  ...
  public ProblemBuilder prepare(
    ...
    if (activeProfiles.contains(ReferentielConstants.SPRING_PROFILE_PRODUCTION)) {
