...
public class SubscriptionService {
  ...
  //       }
  //     }
  //     if (notification.getCounterPartCode() != null) {
  //       Counterpart counterpart =
  //           counterpartService.findByExternalReference(notification.getCounterPartCode());
  //       if (counterpart == null) {
  //         subscription.setStatus(SubscriptionStatus.INCORRECT);
  //         ecart = true;
  //         if (errorMessage.length() > 0) errorMessage.append(" et ");
  //         errorMessage.append("Contrepartie inexistant");
  //         // subscription.setCounterpart(null);
  //       } else {
  //         // subscription.setCounterpart(counterpart);
  //       }
  //     }
