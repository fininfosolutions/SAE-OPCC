...
/** JHipster constants. */
@Component
public interface ReferentielConstants {
  ...
  /**
   * Spring profile used when deploying to Amazon ECS Constant <code>
   * SPRING_PROFILE_AWS_ECS="aws-ecs"</code>
   */
  String SPRING_PROFILE_AWS_ECS = "aws-ecs";

  /**
   * Spring profile used when deploying to Microsoft Azure Constant <code>
   * SPRING_PROFILE_AZURE="azure"</code>
   */
